...
class FigShare(models.Model):
    ...
    json_file = models.FileField(default="",upload_to='/json/%Y/%m/',verbose_name='JSON Meta Data File' , blank=False ,help_text="Please upload the json meta data file") # META data file  
